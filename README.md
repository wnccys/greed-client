# greed-client
greed-client is a game launcher with it's own bittorrent client that allows online sessions and has features a dynamic magnet links scrapper that keeps all the games updated.
