...
export function Settings() {
	...
	return (
		...
		>
			<Tabs.Root
				className="flex flex-col shadow-lg shadow-black w-[30rem]"
				defaultValue="tab1"
			>
				<Tabs.List className="shrink-0 flex border-b border-mauve6" aria-label="Manage your account">
				<Tabs.Trigger
					className="bg-zinc-900 px-5 h-[45px] flex-1 flex items-center justify-center text-[15px] 
				...
				<Tabs.Trigger
					className="bg-zinc-900 px-5 h-[45px] flex-1 flex items-center justify-center 
					...
					data-[state=active]:shadow-[inset_0_-1px_0_0,0_1px_0_0]
					 data-[state=active]:focus:shadow-white outline-none cursor-default"
					value="tab2"
				>
					Sources
				</Tabs.Trigger>
				...
				<Tabs.Content
				className="grow p-5 bg-zinc-900 rounded-b-md outline-none focus:shadow-[0_0_0_2px] focus:shadow-black"
				value="tab1"
				>
				<fieldset className="mb-[15px] w-full flex flex-col justify-start pt-4">
					<label className="text-[13px] leading-none mb-2.5 text-white block" htmlFor="name">
						Default Download Path
					</label>
					<input
						className="grow shrink-0 rounded px-2.5 text-[15px] leading-none text-black w-[15rem]
						shadow-[0_0_0_1px] shadow-violet7 h-[35px] focus:shadow-[0_0_0_2px] focus:shadow-violet8 outline-none"
						id="name"
