...
export function Library() {
        ...
        return (
            <TooltipProvider>
                <Tooltip>
                    ...
                    className="hover:bg-red-500 transition-all duration-300 border-none"> 
    ...
    return (
        <div className="min-h-screen mt-[4rem] flex gap-2 justify-between">
            {library && (library.map((libraryItem, index) => {
                return (
                    ...
                    <div className="ms-10 flex" key={index}>
                        ...
                        >
                            <img src={libraryItem.icon} className="max-h-8 rounded-xl pe-8" alt="game-icon" />
